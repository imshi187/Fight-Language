...
class Tokenizer:
    def __init__(self, source_code):
        ...
        self.keywords: List[str] = ["const", 'lambda', 'let', 'if', "for", "in", 'else', "elif", 'break', 'loop', "def",
                                    ...
                                    "catch", "try", "finally", "as", "set", "struct", "enum", "annotation", "generator",
                                    "step", "use", "exports", "super",
                                    # 关键字
                                    "int", "float", "string", "object", "list", "set", "bool", "void", "enum",
                                    "function", "any", "struct"
                                    ]
    ...
    def tokenize(self):
        ...
        while self.current_char is not None:
            ...
            # 中文的
                ...
                tokens.append(('Chinese_COMMA', self.current_char))
                self.advance()
            # 。
            elif self.current_char == '。':
                tokens.append(('Chinese_PERIOD', self.current_char))
                self.advance()
            # !
            elif self.current_char == '!':
                tokens.append(('BANG', self.current_char))
                self.advance()
