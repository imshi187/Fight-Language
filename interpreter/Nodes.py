...
class ImportModuleNode(Node):
    ...
    def __repr__(self):
        return f"ImportModuleNode(third_party = {self.third_party},module_name={self.module_name}, import_elements={self.import_elements}, import_whole_module={self.import_whole_module}, alias={self.alias})"


# import {模块名称} from "文件路径"
class ImportThirdPartyModuleNode(Node):
    def __init__(self, file_path, package_name, import_elements: list = [], import_whole_module=True, alias=None, ):
    ...
    def __repr__(self):
        return f"ImportThirdPartyModuleNode(package_name={self.package_name}, file_path={self.file_path}, import_elements={self.import_elements}, import_whole_module={self.import_whole_module}, alias={self.alias})"
...
class AssignmentNode(Node):
    # name = value
    def __init__(self, name, value, data_type=None, is_constant=False, from_module=None):
        self.name = name
        self.value = value
    ...
    def __repr__(self):
        return f"AssignmentNode(name={self.name}, data_type={self.data_type}, value={self.value}, is_constant={self.is_constant},from_module={self.from_module})"
...
class ReAssignmentNode(Node):
    ...
    def __repr__(self):
        return f"ReAssignmentNode(name={self.name},  value={self.value})"
...
class ObjectNode(Node):
    ...
    def __repr__(self):
        return f"ObjectNode(k_v={self.k_v})"
...
class FunctionDeclarationNode:
    def __init__(self, name, args, body, default_values: dict = {}, is_static=False, func_type=None, tag=None,
                 annotations: dict = {}, from_module=None, return_type: dict = {}, params_types: dict = {}):
        # 函数注解
        self.from_module = from_module
    ...
    def __repr__(self):
        return f"FunctionDeclarationNode(params_types={self.params_types},return_type={self.return_type},from_module={self.from_module},annotations = {self.annotations},tag = {self.tag},func_type={self.func_type},name={self.name}, args={self.args}, body={self.body}, default_values={self.default_values}, is_static={self.is_static},)"
...
class StructDeclarationNode(Node):
    def __init__(self, struct_name, fields: dict = {}, fields_types: dict = {}):
    ...
    def __repr__(self):
        return f"StructDeclarationNode(name={self.struct_name}, fields_types={self.fields_types},fields={self.fields})"
...
class StructAccessNode(Node):
    def __init__(self, struct_instance_name, field_name,fields_names: list = []):
        self.struct_instance_name = struct_instance_name
        self.field_name = field_name
        self.fields_names = fields_names

    def __repr__(self):
        return f"StructAccessNode(name={self.struct_instance_name}, field_name={self.field_name},fields_names={self.fields_names})"
...
class LogicNotNode(Node):
    ...
    def __repr__(self):
        return f"LogicNotNode(expr={self.expr})"
