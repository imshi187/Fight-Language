...
class AssignmentNode(Node):
    # name = value
    def __init__(self, name, value, is_constant=False,from_module=None):
        self.name = name
        self.value = value
    ...
    def __repr__(self):
        return f"AssignmentNode(from_module={self.from_module},name={self.name}, value={self.value}, is_constant={self.is_constant})"
...
class FunctionDeclarationNode:
    def __init__(self, name, args, body, default_values: dict = {}, is_static=False, func_type=None, tag=None,
                 annotations: dict = {},from_module=None):
        # 函数注解
        self.from_module = from_module
    ...
    def __repr__(self):
        return f"FunctionDeclarationNode(,from_module={self.from_module},annotations = {self.annotations},tag = {self.tag},func_type={self.func_type},name={self.name}, args={self.args}, body={self.body}, default_values={self.default_values}, is_static={self.is_static},)"
