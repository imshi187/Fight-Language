...
class ClassDeclarationNode(Node):
    ...
    def __repr__(self):
        return f"ClassDeclarationNode(init = {self.init},fields_annotations = {self.fields_annotations},interfaces = {self.interfaces},parent_name = {self.parent_name},classname = {self.classname},methods = {self.methods},fields = {self.fields},static_methods = {self.static_methods},static_fields = {self.static_fields})"
