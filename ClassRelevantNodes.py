...
class ClassDeclarationNode(Node):
    ...
    def __repr__(self):
        return f"ClassDeclarationNode(interfaces = {self.interfaces},parent_name = {self.parent_name},classname = {self.classname},methods = {self.methods},fields = {self.fields},init = {self.init},static_methods = {self.static_methods},static_fields = {self.static_fields})"
